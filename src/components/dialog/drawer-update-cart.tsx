...
type TDrawerUpdateCartProps = TItem & {
...
const DrawerUpdateCart = ({ isOpen, onOpenChange, ...itemData }: TDrawerUpdateCartProps) => {
  const uid = useId();
  ...
  return (
    <Drawer
      ...
      className="h-fit max-h-[calc(100dvh-40px)] rounded-t-lg"
    >
      <DrawerClose
        onPress={() => {
          reset();
...
export default DrawerUpdateCart;
